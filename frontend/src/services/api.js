...
export const createTemplate = (name, labelData) =>
  api.post('/api/templates', { name, labelData }).then((r) => r.data);

export const updateTemplate = (id, name, labelData) =>
  api.put(`/api/templates/${id}`, { name, labelData }).then((r) => r.data);

export const deleteTemplate = (id) =>
  api.delete(`/api/templates/${id}`).then((r) => r.data);

export const generatePDF = (id) =>
  api.post(`/api/templates/${id}/pdf`, {}, { responseType: 'blob' }).then((r) => r.data);
